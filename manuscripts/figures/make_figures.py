#!/usr/bin/env python3
"""Regenerate F1-F5 for the asr-gate manuscript from frozen result JSONs.

All figure data flows from ../results/numbers.json (produced by
compute_numbers.py, which reads only frozen result files). No hardcoded arrays.
...
if __name__ == "__main__":
    ...
    print("all figures regenerated from results/numbers.json")
